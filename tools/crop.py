...
# 设置你的文件夹路径
name = r"F:\qBit\manga\[押見修造] おかえりアリス\[押見修造] おかえりアリス 第01巻"
...
batch_crop_images(folder_path, output_folder, crop_edges=(67, 0, 81, 0))  # 向左裁剪10像素，向上裁剪20像素，向右裁剪10像素，向下裁剪20像素
