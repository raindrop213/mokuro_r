...
# 示例使用方法
input_folder = r'H:\website\yuri-hime\title\[(資料集)京都アニメーション] リズと青い鳥\[(資料集)京都アニメーション] リズと青い鳥 原画集\新建文件夹'
output_folder = r'H:\website\yuri-hime\title\[(資料集)京都アニメーション] リズと青い鳥\[(資料集)京都アニメーション] リズと青い鳥 原画集\新建文件夹2'
